...
family(X, Y):-
	...
	write("Mr. "), write(X), write(" is the grandmother of "), write(Y).	
...
family(X, Y):-
	...
	write("Mr. "), write(X), write(" is the granddaughter of "), write(Y).
...
family(X, Y):-
	...
	write("Mr. "), write(X), write(" is the aunty of "), write(Y).	
...
family(X, Y):-
	...
	write("Mr. "), write(X), write(" is the niece of "), write(Y).	
...
family(X, Y):-
	...
	parents(Z, A), parents(Z, B), parents(A, X), parents(B, Y), 
